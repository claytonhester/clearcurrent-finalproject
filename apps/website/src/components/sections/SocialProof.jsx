    ...
    <section className="bg-white">
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20 py-20 md:py-24 lg:py-[120px]">
        ...
        >
          ...
          >
            The pain is real.{' '}
            <span className="text-[var(--gray-600)]">The solution finally is too.</span>
          </motion.h2>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={fadeUp} className="md:col-span-7">
            <div className="h-full bg-[var(--off-white)] rounded-2xl p-10 lg:p-12 relative">
              <span className="absolute top-6 left-8 text-[80px] leading-none text-[var(--gold)]/20 font-[var(--font-display)] select-none">
                "
              </span>
              <div className="relative">
                <p className="text-xl md:text-2xl leading-[1.5] text-[var(--navy)] font-[var(--font-sans)] mt-8">
          ...
          <div className="md:col-span-5 flex flex-col gap-5">
            {testimonials.slice(1).map((t, i) => (
              ...
              >
                <span className="text-3xl leading-none text-[var(--gold)]/30 font-[var(--font-display)] select-none">
                  "
                </span>
                <p className="text-[15px] leading-[1.65] text-[var(--navy)] font-[var(--font-sans)] mt-2">
                  {t.quote}
                </p>
        ...
        {/* Metrics — inline with vertical separators */}
        {/* TODO: confirm with John/Dan — replace with real stats */}
        <motion.div
          variants={stagger}
          initial="hidden"
          whileInView="visible"
