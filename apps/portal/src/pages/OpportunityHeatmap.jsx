...
export function OpportunityHeatmap() {
  ...
  return (
    <div className="space-y-10">
      <PageIntro label="Opportunity Heatmap">{opportunityHeatmap.intro}</PageIntro>

      <section id="priority-map" tabIndex={-1} className="scroll-mt-24 outline-none">
        ...
        <ChartDataTable
          caption="Opportunity scores (same data as the scatter plot above)."
          columns={[
            { key: 'name', label: 'Opportunity' },
            { key: 'value', label: 'Value' },
            { key: 'frequency', label: 'Frequency' },
            { key: 'strategicImpact', label: 'Strategic impact' },
          ]}
          rows={opportunityHeatmap.opportunities.map((o) => ({
            id: o.id,
            name: o.name,
            value: o.value,
            frequency: o.frequency,
            strategicImpact: o.strategicImpact,
          }))}
          exportFilename="opportunity-heatmap.csv"
        />
      </section>

      <div id="opportunity-detail" className="grid scroll-mt-24 gap-6 lg:grid-cols-2">
        <div
          ref={detailPanelRef}
          tabIndex={-1}
          className="rounded-xl border border-cc-mid-gray/15 bg-cc-light-gray/50 p-5 outline-none ring-cc-navy/20 focus-visible:ring-2"
        >
