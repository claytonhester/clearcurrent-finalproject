...
export function ProductModules() {
  ...
  return (
    <div className="space-y-8">
      <div id="module-tabs" className="scroll-mt-24">
      ...
      <div
        ...
        tabIndex={-1}
        key={active.id}
        className="scroll-mt-24 rounded-xl border border-cc-mid-gray/15 bg-cc-white p-6 shadow-sm outline-none transition-all duration-300"
      >
