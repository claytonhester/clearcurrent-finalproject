...
export function TriggerMap() {
  ...
  const pieColors = useMemo(
    () =>
      pieData.map(
        (d) => triggerMap.chart.typeKey[d.key]?.color ?? '#94a3b8',
      ),
    [pieData],
  )
  ...
  return (
    <div className="space-y-8">
      <p className="text-base leading-relaxed text-cc-dark-text">{triggerMap.intro}</p>
      ...
      <ChartCard title={triggerMap.chart.title} legend="Distribution for current filter">
