export const opportunityHeatmap = {
  ...
  opportunities: [
    ...
    },
    {
      ...
      status: 'placeholder',
      detail:
        'Critical during renewals; ties procurement to actual usage and riders.',
    },
    {
      id: 'opp-3',
      ...
      status: 'placeholder',
      detail:
        'Repeats every budget cycle; finance-facing narrative is the core value.',
    },
    {
      id: 'opp-4',
    ...
    },
    {
      ...
      status: 'placeholder',
      detail:
        'Operational rhythm during summer peaks; supports cost and reliability.',
    },
    {
      id: 'opp-6',
      ...
      status: 'placeholder',
      detail:
        'Foundational but often invisible until something breaks.',
    },
  ],
  quoteIds: ['heatmap-1'],
}
