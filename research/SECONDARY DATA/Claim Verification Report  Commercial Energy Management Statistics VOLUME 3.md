...
**Harvard Law School (2025):** A peer-reviewed legal analysis from Harvard's Environmental Law Initiative documents that utility rate cases are structurally asymmetric — utilities generate the information regulators use to set rates, creating persistent information asymmetry that facilitates billing and rate errors. The paper notes that independent audits, not regulatory proceedings, are how most mischarged costs are discovered.[^8]
...
**EIA CBECS (gold standard):** The most recent official CBECS survey was conducted in **2018**, not 2022 or 2024. EIA released the 2018 CBECS data in December 2022. The authoritative figure is: **$141–142 billion in 2018**. There is no EIA survey of commercial energy expenditures for any year after 2018. As of 2025, EIA's AEO modeling still uses the 2018 CBECS as its baseline.[^12][^13][^14][^15]

**The next CBECS:** EIA conducted a new CBECS beginning in 2022, but data collection and modeling for a new CBECS cycle is multi-year. As of 2025–2026, EIA has not published updated CBECS expenditure figures beyond 2018. Any 2024 figure is a projection, not a measured survey result.[^16][^17]

**What the CSS Factsheet says:** The University of Michigan CSS factsheet is an annual synthesis document that extrapolates trends from EIA primary data. The CSS uses the CBECS as a foundation but adjusts for price changes using EIA's Annual Energy Outlook and Short-Term Energy Outlook (STEO) data. Citing CSS as a primary source is one step removed from the actual primary source (EIA).[^11]
...
The survey does not appear to have been published in a peer-reviewed journal or independently verified. The full methodology — sampling frame, population definition, weighting, margin of error — is not disclosed in available public materials.[^23]

### The "9%" Adoption Figure — Source and Corroboration
...
**No U.S. government agency publishes a commercial utility billing error rate.** The EIA, FERC, NARUC, and state PUCs track rate cases and regulatory complaints but do not publish a systematic error rate for commercial billing. This is a genuine data gap.

**Documented independent evidence by error category:**

**Meter reading errors:** The transition from manual to AMI metering has been associated with significant accuracy improvements in residential billing, but commercial meters — which may have CT multipliers, demand interval recording, and complex TOU configurations — are more error-prone. A Rhode Island PUC investigation found that 83% of bills internally flagged as problematic were sent out anyway, indicating the utility's own quality control was failing to prevent errors from reaching customers.[^6]

**Rate misclassification:** Arcadia, the largest commercial utility data aggregator, processes 500,000+ meter-tariff assignments for commercial accounts and reports needing expert manual review for approximately 20% of them — suggesting systematic tariff complexity that utilities may be misapplying.[^10]

**Demand charge errors:** The National Renewable Energy Laboratory (NREL) and DOE have documented that demand charges are frequently misunderstood by commercial customers and are prone to billing disputes, particularly around ratchet clauses and peak demand measurement intervals.[^29][^30]
...
**For higher education specifically:** There is no single government publication that states a dollar figure for higher education energy spending alone. The relevant data must be derived:

- **EIA CBECS 2018:** Education buildings (K-12 + higher ed combined) consumed 854 TBtu in 2018 = 13% of total commercial energy consumption[^34]
- **Education buildings total expenditure (EIA CBECS 2018):** Education buildings spent approximately **$18.5 billion** on energy in 2018 (13% of $142 billion total)[^34][^12]
- **K-12 component:** EPA ENERGY STAR states K-12 spends over $8 billion annually, with NASEO citing $11 billion as a managed figure[^33][^31]
- **Higher education residual:** If total education is ~$18.5 billion and K-12 is ~$8–11 billion, higher education accounts for approximately **$7.5–10.5 billion** of annual energy spend

**APPA (Association of Physical Plant Administrators):** APPA's Facilities Performance Indicators (FPI) program tracks purchased utilities per gross square foot across participating universities, and their database includes 1.1 billion gross square feet of campus space. APPA FPI data is the most authoritative source for higher education energy spending benchmarks, but the specific aggregate spending figure is available only to APPA members.[^35]

**NCES (National Center for Education Statistics):** Total higher education expenditures in 2020–21 were $702 billion. Utilities typically represent 2–3% of total institutional expenditures — consistent with $10–14 billion in annual energy spend for the sector.[^36]

**Energy Star Higher Education Benchmarking Initiative (HEBI):** EPA has run HEBI since 2020 to benchmark campus energy, but no aggregate spending dollar figure is published in publicly available HEBI reports.[^37]
...
A recurring pattern across these claims is the **"audit firm benchmark problem"**: statistics about billing errors, overpayment rates, and energy waste are disproportionately generated by vendors that profit from finding problems. This creates systematic upward bias in published figures. Independent corroboration from government sources (EIA, EPA, FERC, state PUCs) consistently supports the directional claims — billing errors are real, software adoption is low, energy spend is large — but at more conservative magnitudes than vendor-generated statistics suggest.

For a market research report that will be reviewed by sophisticated investors or enterprise buyers, all vendor-generated statistics should either be replaced with primary government/academic sources or explicitly flagged with the conflict of interest. The directional narrative of the Clear Current Technologies opportunity remains compelling and is well-supported by independent evidence; the specific figures simply need to be grounded in defensible sources.

---

## References

1. [Utility Bill Audits - National Utilities Refund](https://nationalutilitiesrefund.com/audits/utility-bill-audits/) - On average, 80 percent of companies are overpaying on utility bills and are owed a utility refund fo...
...
3. [National Utilities Refund: Home](https://nationalutilitiesrefund.com) - The National Utilities Refund works with the client to eliminate errors and overcharges, obtaining r...

4. [FirstEnergy wants Ohio customers to pay for its accounting foul-up](https://energyandpolicy.org/firstenergy-accounting-foul-up/) - A 2022 audit by the Federal Energy Regulatory Commission found that FirstEnergy's subsidiaries may h...

5. [RI Energy billing errors almost cost taxpayers nearly $1 million](https://www.youtube.com/watch?v=Q9fHO6vYLqU) - Report. Comments. 6. Add a comment... 31 ... Exposing The Dark Side of America's AI Data Center Expl...
...
7. [Public Utility Commission Investigating PPL for Billing Issues After ...](https://northpennnow.com/news/2023/feb/03/public-utility-commission-investigating-ppl-for-billing-issues-after-customers-report-high-increases/) - The comprehensive investigation was prompted after receiving numerous reports of unusually high bill...

8. [[PDF] Extracting Profits from the Public: How Utility Ratepayers Are Paying ...](https://eelp.law.harvard.edu/wp-content/uploads/2025/03/Harvard-ELI-Extracting-Profits-from-the-Public.pdf) - Regulated utility rates reimburse utilities for their costs of providing service and provide an oppo...

9. [Utility Billing Errors: A Significant Hidden Cost to Consumers](https://www.360energy.net/resources/post/utility-billing-errors-hidden-cost-consumers) - Inaccurate utility billing data can lead to additional costs for customers ranging from 5% to 15% an...

10. [How Arcadia achieves energy cost accuracy at scale](https://www.arcadia.com/blog/energy-cost-accuracy-scale) - Arcadia automates collection of utility billing and interval data through our Plug product, validati...

11. [Commercial Buildings Factsheet | Center for Sustainable Systems](https://css.umich.edu/publications/factsheets/built-environment/commercial-buildings-factsheet) - Operation accounts for 80–90% of a building's life cycle energy consumption, vs. 10–20% for construc...

12. [Commercial Buildings Energy Consumption Survey (CBECS) - EIA](https://www.eia.gov/consumption/commercial/) - Detailed tables include consumption and expenditures data by energy source in total, per building, a...

13. [U.S. commercial buildings were consuming less energy per ... - EIA](https://www.eia.gov/pressroom/releases/press517.php) - The average total amount of energy used per square foot in commercial buildings decreased by 12% fro...

14. [New data and trends about the commercial building stock](https://atlasbuildingshub.com/2024/02/13/new-data-and-trends-about-the-commercial-building-stock/) - A national sample survey of commercial buildings and all of their energy-related characteristics and...

15. [[PDF] Annual Energy Outlook Overview and Modeling Updates](https://vibe.cira.colostate.edu/ogec/docs/meetings/2025-02-13/03_EIA_NOGEC_Call.pdf) - – The commercial sector uses the 2018 Commercial Building Energy Consumption Survey. • Consumer purc...

16. [Commercial Buildings Energy Consumption Survey (CBECS) - EIA](https://www.eia.gov/consumption/commercial/reports.php) - The Commercial Buildings Energy Consumption Survey (CBECS) is a national sample survey that collects...

17. [Commercial Buildings Energy Consumption Survey (CBECS) - EIA](https://www.eia.gov/consumption/commercial/data/archive.php) - Publications & Reports ; 2018 Commercial Buildings Energy Consumption Survey: Consumption and Expend...

18. [U.S. energy spending increased by more than 20% in 2022 - EIA](https://www.eia.gov/todayinenergy/detail.php?id=62945) - In 2022, energy expenditures—or the amount of money U.S. consumers spent on energy—increased 22% fro...

19. [U.S. energy spending increased by more than 20% in 2022 - LinkedIn](https://www.linkedin.com/posts/u-s-energy-information-administration_us-energy-spending-increased-by-more-than-activity-7234965786778386433-FpIH) - More money was spent on energy in the United States on an inflation-adjusted basis in 2022 than in a...

20. [U.S. power use to reach record high in 2022 as economy grows, EIA ...](https://www.933thedrive.com/2022/08/09/u-s-power-use-to-reach-record-high-in-2022-as-economy-grows-eia-says/) - EIA projected 2022 power sales would rise to 1,494 billion kWh for residential consumers, 1,371 bill...

21. [US power use to reach record highs in 2024 and 2025, EIA forecast ...](https://www.reuters.com/business/energy/us-power-use-reach-record-highs-2024-2025-eia-forecast-says-2024-12-10/) - EIA projected 2024 gas sales would ease to 12.1 billion cubic feet per day for residential consumers...

22. [New Survey on Commercial Building Energy Efficiency: Combating ...](https://www.prweb.com/releases/New_Survey_on_Commercial_Building_Energy_Efficiency_Combating_Rising_Energy_Costs_and_Reducing_Consumption_are_Top_Concerns/prweb19169229.htm) - Commissioned by GridPoint, The Commercial Building Energy Efficiency Survey was conducted by Qualtri...

23. [[PDF] 90% 94% 92% 828 79% 98% - GridPoint](https://www.gridpoint.com/wp-content/uploads/2023/02/GridPoint_Energy_Survey_2023.pdf) - Demand response refers to changes in electric usage by consumers in response to high-use periods to ...

24. [New Survey on Commercial Building Energy Efficiency - GridPoint](https://www.gridpoint.com/new-survey-on-commercial-building-energy-efficiency-combating-rising-energy-costs-and-reducing-consumption-are-top-concerns/) - GridPoint unveils results of “The Commercial Building Energy Efficiency Survey” with insight from mo...

25. [[PDF] Trends in Commercial Whole-Building Sensors and Controls - EIA](https://www.eia.gov/analysis/studies/buildings/commercial/sensors/pdf/sensors_controls.pdf) - This report was prepared by the U.S. Energy Information Administration (EIA), the statistical and an...

26. [About ENERGY STAR for Commercial Buildings](https://www.energystar.gov/buildings/about-us) - EPA's free online ENERGY STAR Portfolio Manager® tool is the industry standard for measuring and tra...

27. [[PDF] 2023 ENERGY STAR Annual Overview Report](https://www.energystar.gov/sites/default/files/2024-05/Annual%20Overview%20Report_2023.pdf) - More than 330,000 commercial properties use EPA's ENERGY STAR Portfolio Manager® tool to measure and...

28. [Altair's Toggled Survey Reveals Overwhelming Adoption Rates for ...](https://www.prnewswire.com/news-releases/altairs-toggled-survey-reveals-overwhelming-adoption-rates-for-smart-building-tech-significant-headroom-remains-for-data-analytics-in-facilities-management-301829184.html) - 78% of businesses have adopted smart building tech to drive energy efficiency, lower costs, decrease...

29. [What is a demand ratchet? | FEDS](https://feds.pnnl.gov/faq/what-demand-ratchet) - A demand ratchet is a billing method commonly imposed by electric utilities on large commercial or i...

30. [Decoding Your Electric Utility Bill | DemandLab - DemandQ](https://www.demandq.ai/demandlab/decoding-your-utility-bill/) - A ratchet clause is one of the most financially damaging provisions in commercial utility tariffs — ...

31. [K-12 Schools | ENERGY STAR](https://www.energystar.gov/buildings/resources-audience/k-12-schools) - K-12 school districts spend over $8 billion nationwide on energy costs each year. More than 30 perce...

32. [Energy Star in K-12 Schools - National Center on School Infrastructure](https://school-infrastructure.org/resources/energy-star-in-k-12-schools-tn9/) - K-12 school districts spend over $8 billion nationwide on energy costs each year. More than 30 perce...

33. [[PDF] Energy Efficient and Healthy K-12 Public School Facilities:](https://www.naseo.org/data/sites/1/documents/publications/NASEO_EnergyEfficientSchools_v4_Digital_Final.pdf) - The 2018 Commercial Building Energy. Consumption Survey (CBECS) found that the education sector, enc...

34. [Commercial Buildings Energy Consumption Survey (CBECS) - EIA](https://www.eia.gov/consumption/commercial/pba/education.php) - Education buildings used 854 trillion British thermal units (TBtu) of energy in 2018, which was 13% ...

35. [The State of Facilities in Higher Education: Space, Spending, & Staff](https://www.appa.org/the-state-of-facilities-in-higher-education-space-spending-and-staff) - Explore Gordian's State of Facilities in Higher Education report, analyzing campus trends, budget ch...

36. [Fast Facts: Expenditures (75)](https://nces.ed.gov/fastfacts/display.asp?id=75) - Total expenses for postsecondary institutions in the United States were 2 percent lower in 2020–21 t...
